...
\begin{document}
    ...
    \input{parts/1-init}
    \input{parts/2-roadmap}
    \input{parts/3-intro}
    \input{parts/4-atmosfer}
    \input{parts/5-events}
    \input{parts/6-transfer}
    \input{parts/7-ground_wave}
    \input{parts/8-sky_wave}
    \input{parts/9-space_wave}
    \input{parts/10-conclusion}
\end{document}